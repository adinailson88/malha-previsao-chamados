...
A adequacao de Generalized Additive Models e registrada por `scripts/gerar_analise_gam.py`, com saida em `dados/analise_gam.json` e `dados_csv/analise_gam.csv`. No eixo de chamados, GAM e tratado como benchmark explicavel para contagens, com familia Poisson/Negative Binomial a validar por sobredispersao. A metodologia esta em [`docs/METODOLOGIA_GAM.md`](docs/METODOLOGIA_GAM.md).
